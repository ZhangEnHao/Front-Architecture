( function( global, factory ) {
	...
	if ( typeof module === "object" && typeof module.exports === "object" ) {
		...
		// 对于 CommonJS 和类似 CommonJS 的环境，其中适当的 `window`存在，执行工厂并获取 jQuery。
		// 对于没有带有 `document` 的 `window` 的环境（例如Node.js），将工厂暴露为module.exports。
		// 这强调了创建一个真正的“窗口”的必要性。
		// 例如var jQuery = require("jquery")(window);
		// 有关更多信息，请参阅票证 #14549。
		
		// [在NodeJs中使用jQuery？](https://www.cnblogs.com/DonaHero/p/10001804.html)
...
*/
	...
	// 暴露 jQuery 和 $ 标识符，即使在 AMD 中
	// (#7102#comment:10, https://github.com/jquery/jquery/pull/557)
	// 和用于浏览器模拟器的 CommonJS (#13566)
